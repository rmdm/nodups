...
describe('readme', function () {
    ...
    it('"pick" and "omit" simultaneous example', function () {
        const result = nodup([
            { a: 1, b: 3 },
            { a: 2, b: 4 },
            { a: 1, b: 5 },
    ...
    it('"pick" paths example', function () {
        const result = nodup([
            { a: { b: 1, c: 2 }, d: 7 },
            { a: { b: 5, c: 4 }, d: 8 },
            { a: { b: 1, c: 2 }, d: 9 },
    ...
    it('"onUnique" mapping example', function () {
        const result = nodup([ 1, 3, 2, 3 ], { onUnique: (uniq, dups, i, uniqs) => uniqs[i] = uniq * 2 })
